...
namespace WestcoastEducationAdministration.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StudentId,FirstName,LastName,Email,Phone,Address,Competence")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentId,FirstName,LastName,Email,Phone,Address,Competence")] Student student)
        {
